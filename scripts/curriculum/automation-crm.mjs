...
import { AUTOMATION_CRM_GENERATED } from "./deep-content/generated/automation-crm.mjs";
import { AUTOMATION_CRM_DEEP } from "./automation-crm-deep/index.mjs";

export const _automation_crmLessons = [
  {
  ...
  {
    "slug": "lead-scoring-and-qualification",
  ...
  {
    "slug": "mql-vs-sql-definitions",
    "title": "MQL vs SQL Definitions",
    "track": "automation-crm",
    "level": "base",
    "order": 3,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "workflows-and-triggered-campaigns",
    "title": "Workflows and Triggered Campaigns",
    "track": "automation-crm",
    "level": "base",
    "order": 4,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "crm-fundamentals-and-integration",
    "title": "CRM Fundamentals and Integration",
    "track": "automation-crm",
    "level": "base",
    "order": 5,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "drip-and-nurture-campaigns-in-crm",
    "title": "Drip and Nurture Campaigns in CRM",
    "track": "automation-crm",
    "level": "base",
    "order": 6,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "marketing-automation-platforms-compared",
    "title": "Marketing Automation Platforms Compared",
    "track": "automation-crm",
    "level": "base",
    "order": 7,
    "estimatedMinutes": 38,
...
export const automation_crmLessons = applyAllDeepOverrides(_automation_crmLessons, AUTOMATION_CRM_GENERATED, AUTOMATION_CRM_DEEP);
