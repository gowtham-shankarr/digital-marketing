...
import { MARKETING_FUNNELS_GENERATED } from "./deep-content/generated/marketing-funnels.mjs";
import { MARKETING_FUNNELS_DEEP } from "./marketing-funnels-deep/index.mjs";

export const _marketing_funnelsLessons = [
  {
    "slug": "what-is-a-marketing-funnel-and-why-it-matters",
    "title": "What Is a Marketing Funnel and Why It Matters",
  ...
  {
    "slug": "tofu-mofu-and-bofu-explained",
    "title": "TOFU, MOFU, and BOFU Explained",
    "track": "marketing-funnels",
    "level": "base",
    "order": 2,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "aarrr-pirate-metrics-framework",
  ...
  {
    "slug": "extended-purchase-funnel-stages",
    "title": "Extended Purchase Funnel Stages",
    "track": "marketing-funnels",
    "level": "base",
    "order": 5,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "sales-funnels-for-services-and-high-ticket",
    "title": "Sales Funnels for Services and High-Ticket",
    "track": "marketing-funnels",
    "level": "base",
    "order": 7,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "tripwire-and-low-ticket-funnels",
    "title": "Tripwire and Low-Ticket Funnels",
    "track": "marketing-funnels",
    "level": "base",
    "order": 9,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "free-trial-and-saas-funnels",
    "title": "Free Trial and SaaS Funnels",
    "track": "marketing-funnels",
    "level": "base",
    "order": 11,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "e-commerce-and-cart-funnels",
    "title": "E-commerce and Cart Funnels",
    "track": "marketing-funnels",
    "level": "base",
    "order": 12,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "lead-magnets-and-opt-in-offers",
  ...
  {
    "slug": "lead-nurturing-and-follow-up-sequences",
    "title": "Lead Nurturing and Follow-Up Sequences",
    "track": "marketing-funnels",
    "level": "base",
    "order": 14,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "funnel-mapping-and-customer-flow-design",
    "title": "Funnel Mapping and Customer Flow Design",
    "track": "marketing-funnels",
    "level": "base",
    "order": 15,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "funnel-metrics-drop-off-conversion-velocity",
    "title": "Funnel Metrics: Drop-Off, Conversion, Velocity",
    "track": "marketing-funnels",
    "level": "base",
    "order": 16,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "funnel-optimization-and-plugging-leaks",
    "title": "Funnel Optimization and Plugging Leaks",
    "track": "marketing-funnels",
    "level": "base",
    "order": 17,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "funnel-builder-tools-overview",
    "title": "Funnel Builder Tools Overview",
    "track": "marketing-funnels",
    "level": "base",
    "order": 18,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "full-funnel-vs-single-stage-campaigns",
    "title": "Full-Funnel vs Single-Stage Campaigns",
    "track": "marketing-funnels",
    "level": "base",
    "order": 19,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "retention-and-advocacy-funnel-stages",
    "title": "Retention and Advocacy Funnel Stages",
    "track": "marketing-funnels",
    "level": "base",
    "order": 20,
    "estimatedMinutes": 38,
    "summary": "Fifth and sixth stages: keep customers and turn them into promoters — NPS, referrals, UGC.",
    "objectives": [
      "Explain Retention and Advocacy Funnel Stages in plain English with a real brand example",
      "Apply Retention and Advocacy Funnel Stages to a funnel stage and name the right KPI",
      "Work through numeric or scenario examples (not theory only)",
      "Complete the practice deliverable with documented results"
    ],
    "whatIs": "### What is Retention and Advocacy Funnel Stages?\n\n**Retention and Advocacy Funnel Stages** — Fifth and sixth stages: keep customers and turn them into promoters — NPS, referrals, UGC.\n\nRead this section fully. Below, each idea is explained in plain English with enough detail to use on a real client or job interview — not just memorize a definition.\n\n#### 1. Onboarding Day 0–14 emails\n\nThis point matters because it connects directly to **Retention and Advocacy Funnel Stages** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 2. NPS at day 30\n\nThis point matters because it connects directly to **Retention and Advocacy Funnel Stages** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 3. Referral program at aha moment\n\nThis point matters because it connects directly to **Retention and Advocacy Funnel Stages** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 4. Case studies from advocates\n\nThis point matters because it connects directly to **Retention and Advocacy Funnel Stages** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 5. Community for power users\n\nThis point matters because it connects directly to **Retention and Advocacy Funnel Stages** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n### Quick reference\n\n| Question | Answer |\n|----------|--------|\n| **One-line summary** | Fifth and sixth stages: keep customers and turn them into promoters — NPS, referrals, UGC. |\n| **Level** | base — foundational for all marketers |\n| **Proof you learned it** | Practice deliverable + quiz + real brand notes |",
    "whyUse": "**Retention and Advocacy Funnel Stages** turns vague \"we should market more\" into decisions you can defend. Managers and clients ask *why this channel, why this budget, why this message* — this topic gives you the vocabulary and logic to answer with evidence, not opinions.",
    "whenToUse": "Use **Retention and Advocacy Funnel Stages** when writing a marketing plan, auditing a live campaign, preparing for Google/Meta/HubSpot interviews, or building a case study. Skip deep dives here only after you can teach the basics to someone else using a real example.",
    "steps": [
      {
        "title": "Read with a real brand in mind",
        "body": "Open **Casper's** website or ads in another tab. As you read, note one place they already apply (or violate) **Retention and Advocacy Funnel Stages**. Screenshot optional."
      },
      {
        "title": "Write the definition in your own words",
        "body": "Without looking, explain Retention and Advocacy Funnel Stages in 2–3 sentences a friend would understand. If you use jargon (CPC, TOFU, etc.), define it inline."
      },
      {
        "title": "Map to funnel stage",
        "body": "Label this topic: primarily TOFU, MOFU, BOFU, or retention? One sentence why. Example: 'BOFU — removes checkout friction.'"
      ...
      {
        "title": "Complete the practice task",
        "body": "Map retention + advocacy touchpoints for SaaS product."
      },
      {
        "title": "Self-check before quiz",
        "body": "Can you name one real company example, one metric, and one common mistake? If not, re-read Deep dive sections."
    ...
    "example": "### Real funnel snapshot: **Spotify** Free → Premium\n\n| Stage | User behavior | Spotify tactic |\n|-------|---------------|----------------|\n| **TOFU** | Hears about free music | Social ads, podcasts, word of mouth |\n| **MOFU** | Uses free tier daily | Playlists, Discover Weekly (habit) |\n| **BOFU** | Hits ads / offline limit | \"3 months Premium for $0.99\" offer |\n| **Retention** | Stays subscribed | Wrapped, family plan, podcasts |\n\n**Numbers mindset:** If 100M free users and 2% convert to paid monthly, that's 2M new subscribers — funnel math at scale.",
    "realWorld": "### Where you see **Retention and Advocacy Funnel Stages** in the real world\n\n**Dropbox** grew with a referral funnel (free storage for invites) — classic AARRR referral loop.\n\n**Webinar funnels:** HubSpot's free certification courses feed millions of leads into Marketing Hub sales.\n\n**Tripwire:** Ryan Deiss popularized $7 ebook funnels that fund ad spend while backend courses profit.\n\n**Portfolio tip:** Pick one case above and write 5 bullets: situation, tactic, metric, result, what you'd test next.",
    "commonMistakes": "1. **Only reading definitions** — Retention and Advocacy Funnel Stages clicks when you apply it to a named brand with numbers\n2. **Same example for every topic** — compare Nike vs. HubSpot vs. a local shop; context changes tactics\n3. **No baseline metric** — write \"before\" numbers or you cannot prove improvement\n4. **Tool obsession** — software does not replace strategy; learn the why first\n5. **Isolated channel thinking** — tie this lesson to email + ads + site together, not one silo",
    "tryIt": "### Practice — Retention and Advocacy Funnel Stages\n\nMap retention + advocacy touchpoints for SaaS product.\n\n**Use a REAL brand** (e.g. one you shop from, a local business, or a site you admire). **Deliverable:**\n- Brand name\n- What you observed or changed\n- At least **one number** (traffic, followers, price, CTR estimate, etc.)\n- One sentence: what you'd test next week\n\n---\n\n### Templates (from MMS)\n\n#### Funnel stage map\n\n| Stage | Asset | CTA | Metric | Owner |\n\n### Execution checklist\n\n- [ ] Map all touchpoints on one page\n- [ ] Define conversion event per stage in GA4\n- [ ] Identify single biggest leak\n- [ ] Run one A/B test on leak stage",
    "quiz": [
      {
        "question": "Which is the best real-world reference for Retention and Advocacy Funnel Stages?",
        "options": [
          "Casper — study their live marketing",
          "A random meme page",
          "Ignore all brands",
      ...
      {
        "question": "\"Onboarding Day 0–14 emails\" in practice means…",
        "options": [
          "Onboarding Day 0–14 emails",
          "Memorize without using",
          "Only for enterprise",
          "Not measurable"
        ],
  ...
  {
    "slug": "user-journey-maps-by-business-type",
    "title": "User Journey Maps by Business Type",
    "track": "marketing-funnels",
    "level": "intermediate",
    "order": 21,
    "estimatedMinutes": 38,
    "summary": "SaaS, e-commerce, services — different journeys same funnel logic.",
    "objectives": [
      "Explain User Journey Maps by Business Type in plain English with a real brand example",
      "Apply User Journey Maps by Business Type to a funnel stage and name the right KPI",
      "Work through numeric or scenario examples (not theory only)",
      "Complete the practice deliverable with documented results"
    ],
    "whatIs": "### What is User Journey Maps by Business Type?\n\n**User Journey Maps by Business Type** — SaaS, e-commerce, services — different journeys same funnel logic.\n\nRead this section fully. Below, each idea is explained in plain English with enough detail to use on a real client or job interview — not just memorize a definition.\n\n#### 1. SaaS: trial → activation → expand\n\nThis point matters because it connects directly to **User Journey Maps by Business Type** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 2. Ecom: browse → buy → repeat\n\nThis point matters because it connects directly to **User Journey Maps by Business Type** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 3. Services: call → proposal → close\n\nThis point matters because it connects directly to **User Journey Maps by Business Type** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n#### 4. Document emotions per step\n\nThis point matters because it connects directly to **User Journey Maps by Business Type** in live campaigns. When you audit a brand, look for evidence of this principle in their website, ads, or emails — then note what they do well and what you would fix.\n\n### Quick reference\n\n| Question | Answer |\n|----------|--------|\n| **One-line summary** | SaaS, e-commerce, services — different journeys same funnel logic. |\n| **Level** | intermediate — apply after Module 1–2 |\n| **Proof you learned it** | Practice deliverable + quiz + real brand notes |",
    "whyUse": "**User Journey Maps by Business Type** turns vague \"we should market more\" into decisions you can defend. Managers and clients ask *why this channel, why this budget, why this message* — this topic gives you the vocabulary and logic to answer with evidence, not opinions.",
    "whenToUse": "Use **User Journey Maps by Business Type** when writing a marketing plan, auditing a live campaign, preparing for Google/Meta/HubSpot interviews, or building a case study. Skip deep dives here only after you can teach the basics to someone else using a real example.",
    "steps": [
      {
        "title": "Read with a real brand in mind",
        "body": "Open **Spotify's** website or ads in another tab. As you read, note one place they already apply (or violate) **User Journey Maps by Business Type**. Screenshot optional."
      },
      {
        "title": "Write the definition in your own words",
        "body": "Without looking, explain User Journey Maps by Business Type in 2–3 sentences a friend would understand. If you use jargon (CPC, TOFU, etc.), define it inline."
      },
      {
        "title": "Map to funnel stage",
        "body": "Label this topic: primarily TOFU, MOFU, BOFU, or retention? One sentence why. Example: 'BOFU — removes checkout friction.'"
      ...
      {
        "title": "Complete the practice task",
        "body": "Build journey map for one business type."
      },
      {
        "title": "Self-check before quiz",
        "body": "Can you name one real company example, one metric, and one common mistake? If not, re-read Deep dive sections."
    ...
    "example": "### Real-world scenario: **Spotify**\n\n**Context:** SaaS, e-commerce, services — different journeys same funnel logic.\n\n**What the marketing team did:**\n1. Audited current performance (baseline metrics documented)\n2. Applied **User Journey Maps by Business Type** to the highest-impact customer segment first\n3. Ran a 2-week test with $500–$2,000 or equivalent time budget\n4. Measured results weekly against one primary KPI\n\n**Sample results pattern (illustrative):**\n\n| Metric | Before | After |\n|--------|--------|-------|\n| Primary KPI | Baseline | +15–30% improvement |\n| Cost efficiency | Unknown | Clear CPA/ROAS |\n| Learning | — | Documented in retrospective |\n\n**Your job in the Practice tab:** Recreate this thinking for a brand you choose — real or fictional — with numbers you research or estimate realistically.",
    "realWorld": "### Where you see **User Journey Maps by Business Type** in the real world\n\n**Dropbox** grew with a referral funnel (free storage for invites) — classic AARRR referral loop.\n\n**Webinar funnels:** HubSpot's free certification courses feed millions of leads into Marketing Hub sales.\n\n**Tripwire:** Ryan Deiss popularized $7 ebook funnels that fund ad spend while backend courses profit.\n\n**Portfolio tip:** Pick one case above and write 5 bullets: situation, tactic, metric, result, what you'd test next.",
    "commonMistakes": "1. **Only reading definitions** — User Journey Maps by Business Type clicks when you apply it to a named brand with numbers\n2. **Same example for every topic** — compare Nike vs. HubSpot vs. a local shop; context changes tactics\n3. **No baseline metric** — write \"before\" numbers or you cannot prove improvement\n4. **Tool obsession** — software does not replace strategy; learn the why first\n5. **Isolated channel thinking** — tie this lesson to email + ads + site together, not one silo",
    "tryIt": "### Practice — User Journey Maps by Business Type\n\nBuild journey map for one business type.\n\n**Use a REAL brand** (e.g. one you shop from, a local business, or a site you admire). **Deliverable:**\n- Brand name\n- What you observed or changed\n- At least **one number** (traffic, followers, price, CTR estimate, etc.)\n- One sentence: what you'd test next week\n\n---\n\n### Templates (from MMS)\n\n#### Funnel stage map\n\n| Stage | Asset | CTA | Metric | Owner |\n\n### Execution checklist\n\n- [ ] Map all touchpoints on one page\n- [ ] Define conversion event per stage in GA4\n- [ ] Identify single biggest leak\n- [ ] Run one A/B test on leak stage",
    "quiz": [
      {
        "question": "Which is the best real-world reference for User Journey Maps by Business Type?",
        "options": [
          "Spotify — study their live marketing",
          "A random meme page",
          "Ignore all brands",
      ...
      {
        "question": "\"SaaS\" in practice means…",
        "options": [
          "SaaS: trial → activation → expand",
          "Memorize without using",
          "Only for enterprise",
          "Not measurable"
        ],
...
export const marketing_funnelsLessons = applyAllDeepOverrides(_marketing_funnelsLessons, MARKETING_FUNNELS_GENERATED, MARKETING_FUNNELS_DEEP);
