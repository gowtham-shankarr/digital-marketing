...
import { STRATEGY_BRANDING_GENERATED } from "./deep-content/generated/strategy-branding.mjs";
import { STRATEGY_BRANDING_DEEP } from "./strategy-branding-deep/index.mjs";

export const _strategy_brandingLessons = [
  {
    "slug": "building-a-digital-marketing-strategy-end-to-end",
    "title": "Building a Digital Marketing Strategy End-to-End",
  ...
  {
    "slug": "branding-brand-voice-and-positioning",
    "title": "Branding, Brand Voice, and Positioning",
    "track": "strategy-branding",
    "level": "base",
    "order": 2,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "competitive-and-market-analysis",
  ...
  {
    "slug": "budgeting-and-channel-allocation",
    "title": "Budgeting and Channel Allocation",
    "track": "strategy-branding",
    "level": "base",
    "order": 4,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "campaign-planning-and-project-management",
    "title": "Campaign Planning and Project Management",
    "track": "strategy-branding",
    "level": "base",
    "order": 5,
    "estimatedMinutes": 38,
  ...
  {
    "slug": "integrated-multi-channel-campaigns",
    "title": "Integrated Multi-Channel Campaigns",
    "track": "strategy-branding",
    "level": "base",
    "order": 6,
    "estimatedMinutes": 38,
...
export const strategy_brandingLessons = applyAllDeepOverrides(_strategy_brandingLessons, STRATEGY_BRANDING_GENERATED, STRATEGY_BRANDING_DEEP);
